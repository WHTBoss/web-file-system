        ...
        <div class="row">
            ...
            <div class="body" :style="BodyWidth" :key="ChangeCount" ref="Body">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <admin-main-top></admin-main-top>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <admin-main-body></admin-main-body>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <admin-main-line></admin-main-line>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-4">
                            <admin-main-left></admin-main-left>
                        </div>
                        <div class="col-md-4">
                            <admin-main-center></admin-main-center>
                        </div>
                        <div class="col-md-4">
                            <admin-main-right></admin-main-right>
                        </div>
                    </div>
                </div>
            </div>
